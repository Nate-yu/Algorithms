...
public final class In {
    ...
    ///// begin: section (1 of 2) of code duplicated from Graph.In to StdIn.
    ...
    //// end: section (1 of 2) of code duplicated from Graph.In to StdIn.
    ...
    ////  begin: section (2 of 2) of code duplicated from Graph.In to StdIn,
    ...
    public char readChar() {
        ...
        try {
            ...
            assert ch.length() == 1 : "Internal (Std)Graph.In.readChar() error!"
    ...
    ///// end: section (2 of 2) of code duplicated from Graph.In to StdIn */
     ...
     * @deprecated Replaced by {@code new Graph.In(filename)}.{@link #readAllInts()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new Graph.In(filename)}.{@link #readAllDoubles()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new Graph.In(filename)}.{@link #readAllStrings()}.
     */
    @Deprecated
    ...
    /**
     * Unit tests the {@code Graph.In} data type.
     *
